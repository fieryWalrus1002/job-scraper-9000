        ...
        <div className="flex gap-8 items-start">
          ...
          <div className="flex-1 min-w-0 flex flex-col gap-6">
            ...
            <div hidden={active !== 'account'}>
              <AccountSection
                // Remount when the server data changes (e.g. after a save) so the
                // section's local form state re-seeds from fresh props — same
                // keyed-remount pattern as ProfileForm / SearchForm above.
                key={`account-${data?.search_updated_at ?? 'new'}`}
